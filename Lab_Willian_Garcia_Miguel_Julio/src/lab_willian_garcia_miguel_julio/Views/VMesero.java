...
public class VMesero extends javax.swing.JFrame {
    ...
    public VMesero(Mesero Empleado,Restaurante rest, Mesa table) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jButton1.setText("<html>Carta/<br/>Facturar</html>");
        ...
        jLabel1.setText("Mesas a cargo:");

        jLabel2.setText("Numero mesas");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        Esc_Mesa v1= new Esc_Mesa(Empleado,rest,table);
        v1.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VMesero.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VMesero(Empleado,rest,table).setVisible(true);
            }
        });
    }
